На Алисе установлен motion https://github.com/Motion-Project/motion

Конфиги находятся в `/usr/local/etc/motion/`
...
Для добавления новой камеры надо дописать в конце `motion.conf` пусть к файлу конфига новой камеры и перезапустить motion.
